 ...
 */
@Service
public final class TranslatorService implements ITranslatorService {
     ...
     */
    @Inject
    public TranslatorService(ResourceBundle resources) {
...
//        return stringList;
    ...
    @Override
    public <T> StringConverter<T> getConvertor(final TranslatorService.Key key) {
