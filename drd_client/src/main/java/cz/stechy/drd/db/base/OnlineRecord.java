 ...
 */
public abstract class OnlineRecord extends Row {
     ...
     */
    protected OnlineRecord(String id, String author, boolean downloaded, boolean uploaded) {
        super(id);
    ...
    public void update(Row other) {
        ...
        OnlineRecord onlineRecord = (OnlineRecord) other;
        setDownloaded(onlineRecord.isDownloaded());
        setUploaded(onlineRecord.isUploaded());
    }

    @Override
    public List<String> getDiffList(Row other) {
        final List<String> diffList = super.getDiffList(other);
        final OnlineRecord onlineRecord = (OnlineRecord) other;

        if (!Objects.equals(this.getAuthor(), onlineRecord.getAuthor())) {
